import { d as clsx } from "./shell-Bg1mD7Ab.js";
import { e as commonjsGlobal, x as getDefaultExportFromCjs, T as reactExports, R as React } from "./server-BQFeF0xS.js";
var isArray_1;
...
var _excluded$g = ["children"], _excluded2$4 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$g(_ref2, _excluded2$4);
    if (nextChildren && prevChildren) {
...
var _excluded$b = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], _excluded2$3 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$l() {
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$b(props, _excluded2$3);
...
var _excluded$8 = ["valueAccessor"], _excluded2$2 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$8(restProps, _excluded2$2);
  if (!data || !data.length) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(Layer, {
...
var mapObject = function mapObject2(fn, obj) {
  return Object.keys(obj).reduce(function(res, key) {
    return _objectSpread$j(_objectSpread$j({}, res), {}, _defineProperty$n({}, key, fn(key, obj[key])));
  }, {});
};
...
const configUpdate = (function(from, to, easing, duration, render) {
  ...
  var timingStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$i(_objectSpread$i({}, res), {}, _defineProperty$m({}, key, [from[key], to[key]]));
  }, {});
  var stepperStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$i(_objectSpread$i({}, res), {}, _defineProperty$m({}, key, {
      from: from[key],
      velocity: 0,
      to: to[key]
    }));
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function(res, entry) {
    return _objectSpread$c(_objectSpread$c({}, res), {}, _defineProperty$g({}, entry + camelName, value));
  }, {});
  result[name] = value;
  return result;
};
...
var formatAxisMap = function formatAxisMap2(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    return _objectSpread$8(_objectSpread$8({}, result), {}, _defineProperty$c({}, id, finalAxis));
  }, {});
};
...
var createLabeledScales = function createLabeledScales2(options) {
  var scales = Object.keys(options).reduce(function(res, key) {
    return _objectSpread$8(_objectSpread$8({}, res), {}, _defineProperty$c({}, key, ScaleHelper.create(options[key])));
  }, {});
...
export {
  ...
  useChartWidth as n,
  useOffset as o,
  useYAxisWithFiniteDomainOrRandom as p,
