import { a5 as useRouter, T as reactExports, K as jsxRuntimeExports, R as React, a as React$1 } from "./server-BQFeF0xS.js";
import { L as Link, r as reactDomExports, R as ReactDOM, b as useSearch, u as useNavigate } from "./router-7feY-ONK.js";
...
const NAV = [
  ...
  { to: "/mapping", label: "Maps", icon: Map$1 },
...
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden lg:flex w-60 shrink-0 flex-col border-r border-border bg-card/40 px-3 py-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 pb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-md bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Vote, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tracking-tight", children: "Mumbai 2024" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "Parliament vs State" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-0.5", children: NAV.map(({ to, label, icon: Icon2 }) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto px-2 pt-4 text-[10px] text-muted-foreground leading-relaxed", children: [
      "Official results · ECI / IndiaVotes ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "Built by Mouni Malyala mouni221100@gmail.com"
    ] })
  ] });
}
...
function useFilters() {
  ...
  const pc = search.pc || "all";
  const metric = search.metric || "margin";
  return {
    pc,
    metric,
    setPC: (v) => navigate({ to: ".", search: (s) => ({ ...s, pc: v }), replace: true }),
    setMetric: (v) => navigate({ to: ".", search: (s) => ({ ...s, metric: v }), replace: true })
  };
}
const PC_RESULTS = [
  {
...
function aggregatePCSeats(pcs = PC_RESULTS) {
  let mva = 0;
  let mahayuti = 0;
  for (const p of pcs) {
...
function pcBySlug(slug) {
  return PC_RESULTS.find((p) => p.pc_slug === slug);
}
function lsAllianceForAC(pcSlug2) {
  return pcBySlug(pcSlug2)?.lok_sabha_2024.winning_alliance ?? "MVA";
}
function filterPCs(slug) {
...
function pcSlug(pc) {
  return PC_LIST.find((p) => p.name === pc).slug;
}
function pcRow(pc) {
  return PC_LIST.find((p) => p.name === pc).row;
}
const ACS = RAW.flatMap(
  (row, rowIdx) => row.map((r2, colIdx) => {
    const ls = {
      winning_alliance: r2.ls[0],
      winning_party: r2.ls[1],
      candidate: cleanCandidate(r2.ls[2]),
      vote_share_pct: r2.ls[3],
      margin_votes: r2.ls[4],
      turnout_pct: r2.ls[5]
    };
    const vs = {
      winning_alliance: r2.vs[0],
      winning_party: r2.vs[1],
      candidate: cleanCandidate(r2.vs[2]),
      vote_share_pct: r2.vs[3],
      margin_votes: r2.vs[4],
      turnout_pct: r2.vs[5]
    };
    ...
    return {
      ...
      ac_name: r2.name,
      parent_pc: r2.pc,
      pc_slug: pcSlug(r2.pc),
      col: colIdx,
      row: pcRow(r2.pc),
      lok_sabha_2024: ls,
      vidhan_sabha_2024: vs,
      metrics: {
...
function aggregateSeats(cycle, acs = ACS) {
  if (cycle === "ls") {
...
function TopBar() {
  ...
  const { location } = useRouterState();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-20 border-b border-border bg-background/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-14 items-center gap-3 px-4 lg:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tracking-tight", children: "Mumbai 2024" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-wider text-muted-foreground hidden sm:inline", children: "Region" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: pc, onValueChange: setPC, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Mumbai (6 PCs)" }),
          PC_LIST.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: p.slug, children: p.name }, p.slug))
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-wider text-muted-foreground hidden sm:inline", children: "Metric" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: metric, onValueChange: (v) => setMetric(v), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "vote_share", children: "Vote Share" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "margin", children: "Margin" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "turnout", children: "Turnout" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "ml-auto flex items-center gap-1 lg:hidden", children: TABS.map(({ to, label, icon: Icon2 }) => {
      const active = location.pathname === to;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto hidden lg:flex items-center gap-3 text-[10px] uppercase tracking-wider text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-sm", style: { background: "var(--mahayuti)" } }),
        " Mahayuti"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-sm", style: { background: "var(--mva)" } }),
        " MVA"
      ] })
    ] })
  ] }) });
...
function Shell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 lg:px-6 py-5", children })
    ] })
  ] });
}
export {
